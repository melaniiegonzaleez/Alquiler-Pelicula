...
<html lang="es">
    ...
    <body>
        ...
        <nav class="menu">
                ...
                <li><a href="ingresarpelicula.php">Administrador</a></li>
                </ul>    
            </nav>     
        </header>
        <table border=1 align="center" id="tabla">
<h1>
    Somos una pequeña empresa proveniente de Asuncion, Paraguay. Nos encargamos de alquilar las peliculas taquilleras del momento.
</h1>
</body>
</html>
